...
export class CreateExams1711785630000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createForeignKeys("exams", [
            new TableForeignKey({ columnNames: ["bank_id"], referencedColumnNames: ["id"], referencedTableName: "question_banks", onDelete: "SET NULL" }),
        ...
        await queryRunner.createForeignKeys("exam_logs", [
            new TableForeignKey({ columnNames: ["attempt_id"], referencedColumnNames: ["id"], referencedTableName: "exam_attempts", onDelete: "CASCADE" })
        ]);
    }
