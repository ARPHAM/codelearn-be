...
export class SubmissionsController {
  ...
  getByExercise(@Param('id', ParseUUIDPipe) id: string, @Query() query: ListSubmissionsDto) {
  ...
  updateScore(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateScoreDto, @CurrentUser() user: User) {
